...
loop do |i|
  ...
  if merged_component.count == nodes.count
    puts "everything's finally connected in one big component!"
    puts "last 2 nodes: #{node0}; #{node1}"
    puts "product of their X coords: #{node0[0]*node1[0]}"
    break
  end
end
